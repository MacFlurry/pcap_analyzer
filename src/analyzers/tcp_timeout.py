...
class TCPTimeoutAnalyzer:
    ...
    def _normalize_flow_key(self, src_ip: str, dst_ip: str, src_port: int, dst_port: int) -> str:
    ...
    def _process_metadata(self, metadata: "PacketMetadata", packet_num: int) -> None:
        ...
        # Clé normalisée pour le flux
        flow_key = self._normalize_flow_key(metadata.src_ip, metadata.dst_ip, metadata.src_port, metadata.dst_port)
    ...
    def get_results(self) -> dict[str, Any]:
        ...
        return {
            ...
            "thresholds": {"idle_threshold": self.idle_threshold, "zombie_threshold": self.zombie_threshold},
            "categories": {
