...
- [x] Release `v5.4.9` validated and published (git tag, GitHub release, Docker images).
...
- [x] Align README version badge with current release (`5.4.9`).
- [x] Update architecture documentation header/status to current release (`5.4.9`) with explicit historical note.
